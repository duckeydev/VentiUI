...
const componentMeta = {
  title: "Navigation Link Core",
  description:
    "An enhanced semantic anchor primitive featuring live URL tracing, deep contextual tooltips, and background prefetching channels.",
  version: "v1.1.0",
...
const examples = [
  {
    ...
    description:
      "Activate `richPreview` to intercept cursor coordinates and reveal exact destination path definitions alongside developer metadata tags.",
    code: `<Link 
...
export default function LinkDocsPage() {
  ...
  >({
    "rich-metadata-previews": "preview",
  });
    ...
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
          ...
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Properties parameters and token parameters mapped into the
                central dynamic Link tracker.
              </p>
            </div>
          </div>
        ...
        <footer className="border-t border-border/30 pt-4 text-center text-xs text-muted-foreground/40">
          © 2026 Venti UI Labs. Optimized navigation framework tokens.
        </footer>
      </main>
    </DocsPageFrame>
  );
