...
const componentMeta = {
  ...
  description: "An advanced typographic primitive featuring automatic document structure mapping, explicit semantic tag escapes, and built-in text compilation.",
  version: "v1.2.0",
  sourceUrl: "https://github.com/venti-ui/venti/blob/main/packages/typography.tsx",
};
...
const examples = [
  {
    ...
    description: "Render a large layout designed to match visual variant rules, but mapped to an explicit HTML element tag to protect document structure.",
  ...
  },
  {
    ...
    description: "Pass a standard text string with syntax notation markers. The component automatically maps tokens into valid sub-element trees safely.",
...
const apiProperties = [
  { name: "variant", type: "'h1' | 'h2' | 'h3' | 'h4' | 'body' | 'lead' | 'small' | 'code'", default: "'body'", description: "Controls structural styling parameters like weight, font sizing, tracking, and default colors." },
  { name: "as", type: "React.ElementType", default: "calculated", description: "Explicit element override tag used to decouple design values from strict structural layout trees." },
  { name: "markdown", type: "boolean", default: "false", description: "Enables safe scanning for inline markup syntax, converting patterns into stylized text nodes." },
];

export default function TypographyDocsPage() {
  const [copiedId, setCopiedId] = useState<string | null>(null);
  const [activeTabs, setActiveTabs] = useState<Record<string, "preview" | "code">>({
    "semantic-decoupling": "preview",
  ...
  return (
    ...
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        ...
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Design System", href: "/docs/components#design-system" },
              { label: "Typography", href: "/docs/components/design-system/typography" },
            ]}
          />
        ...
        {/* Live Typography Scaling Previews */}
            ...
            return (
              <section key={example.id} id={example.id} className="space-y-3 scroll-mt-20">
                <div className="flex items-center gap-2">
                  <IconMarkdown className="h-4 w-4 text-primary" />
        ...
        {/* Configuration Properties Reference Matrix Area */}
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Typography API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties parameters and token bounds configuration keys accepted directly by the Typography engine.
              </p>
            </div>
          </div>
        ...
        <footer className="border-t border-border/30 pt-4 text-center text-xs text-muted-foreground/40">
          © 2026 Venti UI Labs. System typographic scales.
        </footer>
      </main>
    </DocsPageFrame>
  );
