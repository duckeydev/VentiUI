...
const componentMeta = {
  ...
  description: "A rich data feedback panel widget optimizing complex asynchronous document sync streams, asset attachments, and server staging lifecycles.",
  version: "v1.1.0",
  sourceUrl: "https://github.com/venti-ui/venti/blob/main/packages/file-uploading-progress.tsx",
};
...
const examples = [
  {
    ...
    description: "Standard active transmission template rendering standard execution metrics along with functional session termination triggers.",
...
/>`,
  ...
  },
  {
    ...
    description: "Staging presentations detailing element layouts when tracking systems intercept valid returns or drop packets cleanly.",
    code: `<div className="space-y-3 w-full max-w-sm">
  {/* Success Parameter Matrix */}
  <FileUploadingProgress fileName="user-avatar-vector.svg" fileSize="1.2 MB" progress={100} status="success" />
  
  {/* Exception Failure Matrix */}
...
const apiProperties = [
  { name: "fileName", type: "string", default: "required", description: "The direct identification string designating the attachment target asset." },
  { name: "fileSize", type: "string", default: "'Unknown size'", description: "Explicit document byte calculation metadata (e.g., '14 KB' or '2 GB')." },
  { name: "progress", type: "number", default: "0", description: "Scalar measurement percentage tracked between absolute parameters 0 and 100." },
  { name: "status", type: "'uploading' | 'success' | 'error'", default: "'uploading'", description: "Drives asset indicator sub-states and swaps tracking themes automatically." },
  { name: "onCancel", type: "() => void", default: "undefined", description: "Optional callback parameter rendering an action close element inside structural header files." },
];
  ...
  return (
    ...
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        {/* Main Interface Content Documentation Header Workspace */}
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              { label: "Docs", href: "/docs" },
              { label: "Data Feedback", href: "/docs/components#feedback" },
              { label: "File Uploading Progress", href: "/docs/components/feedback/file-uploading" },
            ]}
          />
            ...
            return (
              <section key={example.id} id={example.id} className="space-y-3 scroll-mt-20">
                <div className="flex items-center gap-2">
                  <IconCloudUpload className="h-4 w-4 text-primary" />
        ...
        {/* Technical Component Properties Matrix Table Area */}
          ...
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Properties parameters and layout types accepted by the custom file uploading framework tracker card.
              </p>
            </div>
          </div>
