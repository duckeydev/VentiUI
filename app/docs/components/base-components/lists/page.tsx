...
const componentMeta = {
  title: "List",
  description: "A flexible text layout system for structured text arrays, nested layout sequences, configuration logs, and clear operational indexing.",
  version: "v1.1.0",
...
const examples = [
  {
    ...
    description: "The standard list preset featuring structured indentation curves and dynamic nesting markers that downshift bullets automatically.",
  ...
  },
  {
    ...
    description: "Transforms the structure into an ordered decimal sequence. Ideal for tracking sequential pipelines or guide installations.",
...
const apiProperties = [
  { name: "as", type: "'ul' | 'ol'", default: "'ul'", description: "Dictates the underlying HTML tag element structure rendered onto the DOM layout map." },
  { name: "marker", type: "'disc' | 'decimal' | 'none'", default: "'disc'", description: "Sets the geometric styling properties appended to prefix text tracks." },
  { name: "spacing", type: "'condensed' | 'normal' | 'loose'", default: "'normal'", description: "Adjusts structural vertical padding intervals running between item nodes." },
  { name: "className", type: "string", default: "''", description: "Standard utility string parameter for injection of bespoke layout adjustments." },
];
  ...
  return (
    ...
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        ...
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: componentMeta.title, href: "/docs/components/typography/lists" },
            ]}
          />
            ...
            return (
              <section key={example.id} id={example.id} className="space-y-3 scroll-mt-20">
                ...
                <DocsPanel className="overflow-hidden rounded-xl bg-card/20">
                  ...
                  <div className="flex min-h-32 items-center justify-start bg-card/10 p-6 pl-8">
                    {currentTab === "preview" ? (
                      <example.render />
                    ) : (
        ...
        {/* Properties Data Reference Matrix */}
          ...
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Properties parameters and configuration flags accepted by the List and ListItem container system elements.
              </p>
            </div>
          </div>
