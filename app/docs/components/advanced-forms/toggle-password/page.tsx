...
const componentMeta = {
  ...
  description: "A secure string input primitive featuring integrated trailing visibility toggles that morph character masking styles without breaking component focus states.",
  version: "v1.0.0",
...
export default function TogglePasswordDocsPage() {
  const [passwordValue, setPasswordValue] = useState("secret_token_2026");
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Interact with the icon container inside the input track block to change mask states instantly. Focus styles are preserved implicitly.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">TogglePassword API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties parameters and semantic structural configuration handles accepted by the TogglePassword input.
              </p>
            </div>
          </div>
        ...
        <footer className="border-t border-border/30 pt-4 text-center text-xs text-muted-foreground/40">
          © 2026 Venti UI Labs. String obscuring interface design architectures.
        </footer>
      </main>
    </DocsPageFrame>
  );
