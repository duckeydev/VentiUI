...
const componentMeta = {
  ...
  description: "An advanced source markup viewer block configured with continuous line count offsets, dynamic language parameters labels, and cross-browser semantic async copy triggers.",
  version: "v1.0.2",
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          <div className="flex items-center gap-2">
            <IconTerminal className="h-4 w-4 text-primary" />
            <h3 className="text-lg font-bold tracking-tight text-foreground">Interactive Implementation</h3>
          </div>
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Execute a single tap on the copy micro-action switch to sync layout details directly into the OS pasteboard pipeline.
          </p>
            ...
            <div className="flex min-h-64 flex-col items-center justify-center bg-card/10 p-6 overflow-visible">
              {activeTab === "preview" ? (
                ...
                <pre className="w-full overflow-x-auto rounded-lg border border-border/40 bg-muted/20 p-4 font-mono text-xs leading-relaxed text-muted-foreground">
                  <code>{documentationSourceCode}</code>
                </pre>
              )}
            </div>
          </DocsPanel>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">CopyMarkup API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties parameters and typography settings accepted by the CopyMarkup primitive layout.
              </p>
            </div>
          </div>
        ...
        <footer className="border-t border-border/30 pt-4 text-center text-xs text-muted-foreground/40">
          © 2026 Venti UI Labs. System clipboard sync wrappers development toolkit.
        </footer>
      </main>
    </DocsPageFrame>
  );
