...
const componentMeta = {
  title: "Range Slider",
  description: "A tactile value selection control with track fill visualization, live value display, and semantic aria-valuenow mappings.",
  version: "v1.0.0",
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Drag the slider thumb to update the value. The fill track and numeric badge update in real time.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Range API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties accepted by the slider range control primitive.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "label", type: "string", default: "undefined", description: "Label rendered above the slider track." },
                    { name: "showValue", type: "boolean", default: "false", description: "Renders a numeric badge showing the current slider value." },
                    { name: "min", type: "number", default: "0", description: "Minimum allowed value for the slider range." },
                    { name: "max", type: "number", default: "100", description: "Maximum allowed value for the slider range." },
                    { name: "step", type: "number", default: "1", description: "Discrete increment between valid slider values." },
                    { name: "onChange", type: "(value: number) => void", default: "undefined", description: "Callback triggered when the slider value changes." },
                    { name: "error", type: "string", default: "undefined", description: "Error message rendered below the slider with destructive styling." },
                  ].map((prop) => (
