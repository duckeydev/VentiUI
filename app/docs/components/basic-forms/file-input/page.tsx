...
const componentMeta = {
  title: "File Input",
  description: "A drag-and-drop file upload surface with animated file list management, validation hooks, and accessible drop zone semantics.",
  version: "v1.0.0",
  sourceUrl: "https://github.com/venti-ui/venti/blob/main/packages/file-input.tsx",
};
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "File Input", href: "/docs/components/forms/file-input" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Drag files onto the drop zone or click to browse. Observe animated file list entries and removal actions.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">File Input API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties accepted by the drag-and-drop upload surface.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "label", type: "string", default: "undefined", description: "Primary call-to-action text rendered inside the drop zone." },
                    { name: "description", type: "string", default: "undefined", description: "Secondary helper text describing accepted file types or limits." },
                    { name: "error", type: "string", default: "undefined", description: "Error message rendered below the drop zone with destructive styling." },
                    { name: "multiple", type: "boolean", default: "false", description: "Allows selection of multiple files in the file dialog." },
                    { name: "accept", type: "string", default: "undefined", description: "Comma-separated list of accepted MIME types or extensions." },
                    { name: "onChange", type: "(files: FileList | null) => void", default: "undefined", description: "Callback triggered when files are selected via drop or dialog." },
                  ].map((prop) => (
