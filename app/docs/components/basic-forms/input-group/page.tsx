...
const componentMeta = {
  title: "Input Group",
  description: "A composable wrapper that augments input fields with contextual addons, affixes, and icon elements for dense form layouts.",
  version: "v1.0.0",
  sourceUrl: "https://github.com/venti-ui/venti/blob/main/packages/input-group.tsx",
};
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Input Group", href: "/docs/components/forms/input-group" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Combine inputs with icons, text addons, and semantic affixes to construct dense form rows.
          </p>
          ...
          <DocsPanel className="rounded-xl bg-card/20">
            ...
            <div className="flex min-h-64 flex-col items-center justify-center bg-card/10 p-6 overflow-visible gap-6">
              {activeTab === "preview" ? (
                <div className="w-full max-w-xs flex flex-col items-center gap-4">
                  ...
                  <InputGroup leftAddon="https://" rightAddon=".com" leftElement={<IconWorld className="h-4 w-4" />}>
                    <Input 
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Input Group API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties accepted by the Input Group wrapper composition layer.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "leftAddon", type: "React.ReactNode", default: "undefined", description: "Static text or element rendered inside the left border addon region." },
                    { name: "rightAddon", type: "React.ReactNode", default: "undefined", description: "Static text or element rendered inside the right border addon region." },
                    { name: "leftElement", type: "React.ReactNode", default: "undefined", description: "Decorative icon or element positioned inside the input left padding." },
                    { name: "rightElement", type: "React.ReactNode", default: "undefined", description: "Decorative icon or element positioned inside the input right padding." },
                    { name: "children", type: "React.ReactElement", default: "required", description: "Single Input element to be cloned and augmented with spacing classes." },
                    { name: "className", type: "string", default: "undefined", description: "Additional utility classes merged into the flex wrapper." },
                  ].map((prop) => (
