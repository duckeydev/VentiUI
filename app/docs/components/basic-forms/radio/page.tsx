...
const componentMeta = {
  title: "Radio Group",
  description: "A single-select control set with keyboard navigation, group context management, and accessible radio button semantics.",
  version: "v1.0.0",
...
export default function RadioDocsPage() {
  ...
  const exampleCode = `import { RadioGroup, Radio } from "@/components/radio";

export function PlanSelector() {
  return (
    <RadioGroup label="Billing Plan" defaultValue="pro" onValueChange={console.log}>
      <Radio value="free" label="Free" description="Basic features" />
      <Radio value="pro" label="Pro" description="Advanced analytics" />
      ...
      rightBar={
        <DocsOutline
          ...
          items={[
            ...
            { label: "Radio Group Specification Matrix", href: "#props-api" },
          ]}
        />
      }
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Radio Group", href: "/docs/components/forms/radio" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Select a plan tier below. The group maintains single-selection semantics with full keyboard arrow navigation.
          </p>
              ...
              {activeTab === "preview" ? (
                <div className="w-full max-w-xs flex flex-col items-center gap-4">
                  ...
                  <RadioGroup label="Billing Plan" value={plan} onValueChange={setPlan}>
                    <Radio value="free" label="Free Tier" description="Basic features for individuals" />
                    <Radio value="pro" label="Pro Tier" description="Advanced analytics and API access" />
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Radio Group API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties accepted by the Radio Group context wrapper and individual Radio nodes.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "value", type: "string", default: "undefined", description: "Controlled selected value for the entire radio group." },
                    { name: "defaultValue", type: "string", default: "undefined", description: "Uncontrolled initial selected value on first render." },
                    { name: "onValueChange", type: "(value: string) => void", default: "undefined", description: "Callback triggered when a radio option is selected." },
                    { name: "name", type: "string", default: "auto-generated", description: "Shared name attribute for all radio inputs in the group." },
                    { name: "disabled", type: "boolean", default: "false", description: "Disables all radio children within the group context." },
                    { name: "label", type: "string", default: "undefined", description: "Accessible legend label for the radio group fieldset." },
                  ].map((prop) => (
