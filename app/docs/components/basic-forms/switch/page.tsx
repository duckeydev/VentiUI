...
const componentMeta = {
  title: "Switch",
  description: "A tactile toggle control with spring-animated thumb motion, aria-switch semantics, and contextual labeling support.",
  version: "v1.0.0",
...
export default function SwitchDocsPage() {
  ...
  const exampleCode = `import { Switch } from "@/components/switch";
      ...
      rightBar={
        <DocsOutline
          ...
          items={[
            ...
            { label: "Switch Specification Matrix", href: "#props-api" },
          ]}
        />
      }
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Switch", href: "/docs/components/forms/switch" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Toggle the switch to observe spring physics on the thumb and aria-checked state updates.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Switch API Reference</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "checked", type: "boolean", default: "undefined", description: "Controlled checked state of the switch toggle." },
                    { name: "defaultChecked", type: "boolean", default: "false", description: "Uncontrolled initial checked state on first render." },
                    { name: "onCheckedChange", type: "(checked: boolean) => void", default: "undefined", description: "Callback triggered when the toggle state changes." },
                    { name: "label", type: "React.ReactNode", default: "undefined", description: "Primary label rendered beside the switch control." },
