...
const componentMeta = {
  title: "Checkbox",
  description: "A binary selection control with indeterminate state support, accessible labeling, and semantic focus management.",
  version: "v1.0.0",
...
export default function CheckboxDocsPage() {
  ...
  const exampleCode = `import { Checkbox } from "@/components/checkbox";
      ...
      rightBar={
        <DocsOutline
          ...
          items={[
            ...
            { label: "Checkbox Specification Matrix", href: "#props-api" },
          ]}
        />
      }
    >
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Checkbox", href: "/docs/components/forms/checkbox" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Toggle the checkbox and indeterminate state to observe focus rings and aria-pressed semantics.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Checkbox API Reference</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "label", type: "React.ReactNode", default: "undefined", description: "Primary label rendered beside the checkbox control." },
                    { name: "description", type: "React.ReactNode", default: "undefined", description: "Secondary helper text rendered below the label." },
                    { name: "indeterminate", type: "boolean", default: "false", description: "Visual indeterminate state when children have mixed selection." },
                    { name: "error", type: "string", default: "undefined", description: "Error message rendered below the field with destructive styling." },
                    { name: "onCheckedChange", type: "(checked: boolean) => void", default: "undefined", description: "Callback triggered when the checked state changes." },
                    { name: "checked", type: "boolean", default: "undefined", description: "Controlled checked state of the input." },
