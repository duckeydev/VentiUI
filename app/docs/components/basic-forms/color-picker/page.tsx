...
const componentMeta = {
  title: "Color Picker",
  description: "A native color input wrapper with swatch preview, hex value display, and accessible color selection semantics.",
  version: "v1.0.0",
  sourceUrl: "https://github.com/venti-ui/venti/blob/main/packages/color-picker.tsx",
};
      ...
      <main className="py-10 lg:col-span-7 space-y-12 lg:max-w-3xl">
        <div className="space-y-3 border-b border-border pb-6">
          <DocsBreadcrumbs
            items={[
              ...
              { label: "Color Picker", href: "/docs/components/forms/color-picker" },
            ]}
          />
        ...
        <section id="interactive-demo" className="space-y-3 scroll-mt-20">
          ...
          <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
            Click the swatch to open the native color picker. The hex value updates in real time alongside the preview.
          </p>
        ...
        <section id="props-api" className="space-y-4 scroll-mt-20">
          <div className="flex items-center gap-2 border-b border-border/40 pb-2">
            ...
            <div className="space-y-0.5">
              <h2 className="text-lg font-bold tracking-tight text-foreground">Color Picker API Reference</h2>
              <p className="text-xs text-muted-foreground">
                Properties accepted by the color selection control.
              </p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-xs">
                ...
                <tbody className="divide-y divide-border/40 font-medium">
                  {[
                    { name: "label", type: "string", default: "undefined", description: "Label rendered above the color picker control." },
                    { name: "description", type: "string", default: "undefined", description: "Secondary helper text rendered below the label." },
                    { name: "value", type: "string", default: "undefined", description: "Controlled hex color value for the picker." },
                    { name: "defaultValue", type: "string", default: '"#3b82f6"', description: "Uncontrolled initial hex color on first render." },
                    { name: "onChange", type: "(value: string) => void", default: "undefined", description: "Callback triggered when the color value changes." },
